...
## Code:
To access the code used in this project, click this [link](https://github.com/MorganTheAnalyst/Movie_Data_Analysis/blob/master/IMDb_data_Analysis.ipynb) to access it.
